		 ...
		 Log.i("USERNAME-PORT",new Integer(extras.getInt("port")).toString());
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					 ...
					 */
					TimeStampData ob = db.multicast_time_stamp(event.getEvent_id(), extras.getString("ip"), extras.getInt("port"));
					
					if (ob.getTimeStamp() != event.getTime_stamp())
					{
						/*
						...
						extras.putLong("startTs", event.getTime_stamp() +1);
